...
if (!function_exists('slugify')) {
    ...
    {
        $str = mb_convert_encoding((string)$str, 'UTF8', mb_list_encodings());
        $defaults = array(
            'delimiter' => '-',
            'limit' => null,
            'lowercase' => true,
...
if (!function_exists('toWord')) {
    ...
    {
        return $string = ucwords(Str::of($string)->replace(['-', '_'], ' '));
    }
}
if (!function_exists('flash')) {
    function flash($title = null, $message = null, $button = null)
    {
...
if (!function_exists('Guvenlik')) {
    function Guvenlik($deger){
    	$boslukSil  =   Str::of($deger);
    	$TagSil     =   strip_tags($boslukSil,['p','a','h1']);
    	$EtkisizYap =   e($TagSil);
    	return $sonuc=   $EtkisizYap;
    }
}
