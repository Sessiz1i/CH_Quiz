        ...
        <div class="modal-content bg-danger">
            ...
            <form action="{{ route('admin.quizzes.destroy',$quiz->id) }}" method="post">
                ...
                <div class="modal-body ">
                    <h5 class="text-center fw-bold">{{ Str::title('quiz\'i silmek istediğinize eminmisiniz') }}</h5>
                    <h5 class="text-center fw-bold">{{ Str::title('quiz\'i sildiğinizde question silinmez') }}</h5>
