                ...
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        @if (Auth::user() && Auth::user()->role == 'admin')
                            ...
                            <x-jet-nav-link href="{{ route('admin.questions.index') }}" :active="request()->routeIs('*questions.index')">
                                {{ __('Question İşlemleri') }}
                            </x-jet-nav-link>
                        @endif
                    </div>
                </div>
                            ...
                            <x-slot name="trigger">
                                @if ( Auth::user() )
                                    @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                        <button class="flex text-md border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user() && Auth::user()->role == 'admin')
                ...
                <x-jet-responsive-nav-link href="{{ route('admin.questions.index') }}" :active="request()->routeIs('*questions.index')">
                    {{ __('Question İşlemleri') }}
                </x-jet-responsive-nav-link>
